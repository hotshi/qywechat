...
*/
        ...
        btn11.setType("view");  
        btn11.setUrl("http://v7dnxuw.hk1.mofasuidao.cn/qywechat/JSSDKUploadPics.jsp");  
        ...
        btn22.setType("view");  
        btn22.setUrl("https://open.work.weixin.qq.com/wwopen/sso/qrConnect?appid=ww92f5da92bb24696e&agentid=1000002&redirect_uri=http%3A%2F%2Fv7dnxuw.hk1.mofasuidao.cn%2Fqywechat%2FPCAuthorization.jsp&state=state");  

        ViewButton btn23 = new ViewButton();  
        btn23.setName("移动端网页授权");  
        btn23.setType("view");  
        btn23.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx387ddd4850a0f67c&redirect_uri=http%3A%2F%2Fv7dnxuw.hk1.mofasuidao.cn%2Fqywechat%2FMTAuthorization.jsp&response_type=code&scope=snsapi_privateinfo&agentid=1000004&state=hec#wechat_redirect");  
        //btn23.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx387ddd4850a0f67c&redirect_uri=http%3A%2F%2Fv7dnxuw.hk1.mofasuidao.cn%2Fqywechat%2FMTAuthorization.jsp&response_type=code&scope=snsapi_base&state=hec#wechat_redirect");
